...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "History.txt", "README.rdoc", "Rakefile", "lib/zafu.rb", "lib/zafu/compiler.rb", "lib/zafu/controller_methods.rb", "lib/zafu/handler.rb", "lib/zafu/helper.rb", "lib/zafu/info.rb", "lib/zafu/parser.rb", "lib/zafu/parser/ruby_less_tags.rb", "lib/zafu/parser/zafu_context.rb", "lib/zafu/parser/zafu_rules.rb", "lib/zafu/parser/zafu_tags.rb", "lib/zafu/template.rb", "rails/init.rb", "script/console", "script/destroy", "script/generate", "test/test_helper.rb", "test/test_zafu.rb", "zafu-0.0.1.gem", "zafu.gemspec"]
